...
function CustomCursor() {
  ...
  return (
    <>
      <motion.div
        className="fixed z-[9999] h-3 w-3 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 blur-[1px] pointer-events-none mix-blend-difference"
      ...
      {[...Array(4)].map((_, i) => (
        <motion.div
          key={i}
          className="fixed z-[9998] h-1.5 w-1.5 rounded-full bg-pink-400/70 blur-[1px] pointer-events-none"
...
function Features() {
  ...
  return (
    <>
      ...
      <section
        id="features"
        className="relative overflow-hidden bg-[#020202] px-4 py-20 text-white sm:px-6 lg:px-8 cursor-none"
      >
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto mb-20 grid max-w-6xl gap-8 lg:grid-cols-[1.08fr_0.92fr]">
            <motion.div
              ...
              className="group relative overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.04] p-6 shadow-[0_12px_45px_rgba(0,0,0,0.28)] backdrop-blur-xl hover:border-pink-500/40 sm:p-8"
            >
              ...
              <h3 className="mb-4 text-xl font-black leading-tight tracking-tight sm:text-2xl">
            ...
            <motion.div
              ...
              transition={{ duration: 0.65 }}
              viewport={{ once: true, amount: 0.15 }}
              className="group relative overflow-hidden rounded-[30px] border border-white/10 bg-[#08080b]/95 p-6 shadow-[0_16px_55px_rgba(0,0,0,0.35)] backdrop-blur-xl hover:border-purple-500/40"
            >
